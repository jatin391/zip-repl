...
export function Navbar() {
  ...
  const navLinks = [
    ...
    { name: 'Principal\'s Message', href: '/principals-message' },
    {
      ...
      href: '/facilities',
      sublinks: [
        { name: 'Library', href: '/facilities?tab=library' },
        { name: 'Science Labs', href: '/facilities?tab=labs' },
        { name: 'Sports', href: '/facilities?tab=sports' },
        { name: 'Transport', href: '/facilities?tab=transport' },
        { name: 'Smart Classrooms', href: '/facilities?tab=classrooms' },
      ],
    },
